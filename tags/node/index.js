...
(※3) webpack、gulp、Grunt
  4.</p>
    ...
    <div class="title">
            ...
            <h2><a href="/blog/2017-01-08-sh_check_args/">シェルで引数チェック</a></h2>
    ...
    <p><ol>
<li>環境 [Mac] 10.11.6 [GNU bash] 3.2.57  1. 内容  test.shの先頭で第一引数の有無をチェック。
test.sh  if [ &quot;$1&quot; = &quot;&quot; ] then echo &quot;引数を指定して下さい。&quot; exit 1 fi echo &quot;任意の処理&quot; echo &quot;引数は$1&quot; exit 0   実行結果  $ sh test.sh 引数を指定して下さい。 $ sh test.sh hoge 任意の処理 引数はhoge<br /></li>
</ol>
</p>

    <footer>
        <ul class="actions">
            <li><a href="/blog/2017-01-08-sh_check_args/" class="button big">Continue Reading</a></li>
        </ul>
        <ul class="stats">
